...
/** Eric Koncina (2013): Added public function to return ip without displaying it.
  * Could not simply extend the RATS_ class to add the new function, thus the
  * original RATS_ class was added and modified. The "RATSQuadtree" class was
  * not added: thus the modified plugin still requires the original RATS_ plugin.
  **/
                                                                            
public class RATS_For_Plugin implements PlugInFilter {
	ImagePlus imp;
